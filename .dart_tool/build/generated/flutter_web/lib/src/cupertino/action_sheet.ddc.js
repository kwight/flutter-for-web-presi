define(['dart_sdk', 'packages/flutter_web/animation', 'packages/flutter_web/src/animation/animation', 'packages/flutter_web_ui/ui', 'packages/flutter_web/src/foundation/assertions', 'packages/flutter_web/src/gestures/arena', 'packages/vector_math/vector_math_64', 'packages/flutter_web/src/services/clipboard'], function(dart_sdk, animation, animation$, ui, assertions, arena, vector_math_64, clipboard) {
  ...
  (src__cupertino__app.CupertinoApp.new = function(opts) {
    ...
    if (!(routes != null)) dart.assertFailed();
    if (!(navigatorObservers != null)) dart.assertFailed();
    if (!(title != null)) dart.assertFailed();
    if (!(showPerformanceOverlay != null)) dart.assertFailed();
    if (!(checkerboardRasterCacheImages != null)) dart.assertFailed();
    if (!(checkerboardOffscreenLayers != null)) dart.assertFailed();
    if (!(showSemanticsDebugger != null)) dart.assertFailed();
    if (!(debugShowCheckedModeBanner != null)) dart.assertFailed();
  ...
  (src__cupertino__theme._InheritedCupertinoTheme.new = function(opts) {
    ...
    let $creationLocationd_0dea112b090073317d4 = opts && '$creationLocationd_0dea112b090073317d4' in opts ? opts.$creationLocationd_0dea112b090073317d4 : null;
    this.theme = theme;
    if (!(theme != null)) dart.assertFailed();
  ...
  (src__cupertino__action_sheet.CupertinoActionSheet.new = function(opts) {
    ...
    if (!(actions != null || title != null || message != null || cancelButton != null)) dart.assertFailed("An action sheet must have a non-null value for at least one of the following arguments: " + "actions, title, message, or cancelButton");
  ...
  (src__cupertino__action_sheet.CupertinoActionSheetAction.new = function(opts) {
    ...
    this[child$5] = child;
    if (!(child != null)) dart.assertFailed();
    if (!(onPressed != null)) dart.assertFailed();
  ...
  src__cupertino__action_sheet._CupertinoAlertRenderElement = class _CupertinoAlertRenderElement extends src__widgets__framework.RenderObjectElement {
    ...
    forgetChild(child) {
      if (!(dart.equals(child, this[_contentElement]) || dart.equals(child, this[_actionsElement]))) dart.assertFailed();
    ...
    removeChildRenderObject(child) {
      src__rendering__object.RenderObject._check(child);
      if (!(dart.equals(child, this.renderObject.contentSection) || dart.equals(child, this.renderObject.actionsSection))) dart.assertFailed();
    ...
    [_placeChildInSlot](child, slot) {
      if (!(slot != null)) dart.assertFailed();
      switch (slot) {
  ...
  src__cupertino__action_sheet._RenderCupertinoAlert = class _RenderCupertinoAlert extends src__rendering__box.RenderBox {
    ...
    performLayout() {
      ...
      if (!src__rendering__custom_layout.MultiChildLayoutParentData.is(this.actionsSection.parentData)) dart.assertFailed();
    ...
    hitTestChildren(result, opts) {
      ...
      return dart.test(result.addWithPaintOffset({offset: contentSectionParentData.offset, position: position, hitTest: dart.fn((result, transformed) => {
          if (!dart.equals(transformed, position['-'](contentSectionParentData.offset))) dart.assertFailed();
          ...
          if (!dart.equals(transformed, position['-'](actionsSectionParentData.offset))) dart.assertFailed();
  ...
  src__cupertino__action_sheet._ActionButtonParentDataWidget = class _ActionButtonParentDataWidget extends src__widgets__framework.ParentDataWidget$(src__cupertino__action_sheet._CupertinoAlertActionsRenderWidget) {
    applyParentData(renderObject) {
      if (!src__cupertino__action_sheet._ActionButtonParentData.is(renderObject.parentData)) dart.assertFailed();
  ...
  src__cupertino__action_sheet._RenderCupertinoAlertActions = class _RenderCupertinoAlertActions extends RenderBox_RenderBoxContainerDefaultsMixin$ {
    ...
    [_computeMinIntrinsicHeightWithCancel](width) {
      if (!(this.childCount === 2 || this.childCount === 3)) dart.assertFailed();
    ...
    [_computeMinIntrinsicHeightWithoutCancel](width) {
      if (!(dart.notNull(this.childCount) >= 2)) dart.assertFailed();
    ...
    performLayout() {
      ...
      while (child != null) {
        ...
        if (!src__rendering__custom_layout.MultiChildLayoutParentData.is(child.parentData)) dart.assertFailed();
    ...
    [_drawButtonBackgroundsAndDividersStacked](canvas, offset) {
      ...
      let prevChild = null;
      while (child != null) {
        if (!src__cupertino__action_sheet._ActionButtonParentData.is(child.parentData)) dart.assertFailed();
        ...
        if (prevChild != null) {
          if (!src__cupertino__action_sheet._ActionButtonParentData.is(prevChild.parentData)) dart.assertFailed();
